...
public class JMSSender_PutFlow_Java_Compute_0001_Test {

	/*
	 * JMSSender_PutFlow_Java_Compute_0001_Test
	 * Test generated by IBM App Connect Enterprise Toolkit 12.0.10.0 on Oct 24, 2023 6:44:10 PM
	 */
	...
	@Test
	public void JMSSender_PutFlow_Java_Compute_TestCase_001() throws TestException {

		// Define the SpyObjectReference
		SpyObjectReference nodeReference = new SpyObjectReference().application("JMSSender").messageFlow("PutFlow")
				.node("Java Compute");
		...
		try {
			String messageAssemblyPath = "/PutFlow_0000C404_65385683_00000002_0.mxml";
		...
		try {
			...
			String messageAssemblyPath = "/PutFlow_0000C404_65385683_00000002_1.mxml";
			InputStream messageStream = Thread.currentThread().getContextClassLoader()
					.getResourceAsStream(messageAssemblyPath);
			if (messageStream == null) {
				throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
